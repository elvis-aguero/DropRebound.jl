...
#     into `test/test_carreau.jl` and `test_carreau_yasuda.jl`.
#
...
#
# !!! warning "Status"
#     This page derives `src/st_extension.jl`, the *perturbative*
...
# matching `src/st_extension.jl`, which has never carried a separate
...
## external quadrature-rule package needed, matching src/types.jl's own #src
...
# callers were unaffected, and the two places `src/st_extension.jl`
