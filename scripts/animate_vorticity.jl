...
#
# Usage:
#   julia --project=docs scripts/animate_vorticity.jl              # Newtonian
#   julia --project=docs scripts/animate_vorticity.jl --shear      # the 3000 ppm fluid
#   julia --project=docs scripts/animate_vorticity.jl --preview    # three stills, no gif
#
...
if PREVIEW
    ...
    out = joinpath(@__DIR__, "..", "outputs", "figures", "animate_vorticity_" * CASE.tag * "_preview.png")
...
out = joinpath(FIGS, "animate_vorticity_" * CASE.tag * ".gif")
