...
#
# Usage:
#   julia --project=docs scripts/animate_backends.jl            # Newtonian reference case
#   julia --project=docs scripts/animate_backends.jl --shear    # the 3000 ppm fluid
...
function animate(r, tag::String, nm::String)
    ...
    fname = joinpath(@__DIR__, "..", "outputs", "figures",
                     "animate_backends_" * tag * "_" * replace(nm, "/" => "-") * ".gif")
