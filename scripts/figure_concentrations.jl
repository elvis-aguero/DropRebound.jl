...
## Oh 0.0139 to 0.79, and a scan across that range (outputs/csv/upstream_oh_scan.csv) is
...
mkpath(FIGS)
savefig(plt, joinpath(FIGS, "figure_concentrations.png"))
println("wrote ", joinpath(FIGS, "figure_concentrations.png"))
