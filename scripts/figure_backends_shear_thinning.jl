...
#
# Usage: julia --project=docs scripts/figure_backends_shear_thinning.jl
...
for c in CURVES
    ...
    open(joinpath(@__DIR__, "..", "outputs", "csv", "backends_shear_thinning.csv"),
...
out = joinpath(@__DIR__, "..", "outputs", "figures", "figure_backends_shear_thinning")
