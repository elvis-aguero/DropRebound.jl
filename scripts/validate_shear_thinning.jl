...
# src/st_exact_extension.jl) against real shear-thinning experimental
# data: derivations/data/metrics_3000ppm.csv.
#
...
# lambda_c=K, a=m, n=1-m -- see derivations/cross_fluid_derivation.jl).
#
...
# `derivations/generalized_newtonian_hierarchy_derivation.jl` Step 9.
# ---------------------------------------------------------------------------
