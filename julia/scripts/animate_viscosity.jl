...
#
# Usage:
#   julia --project=docs julia/scripts/animate_viscosity.jl            # 3000 ppm
#   julia --project=docs julia/scripts/animate_viscosity.jl --preview  # three stills
...
if PREVIEW
    ...
    out = joinpath(@__DIR__, "..", "..", "results", "preview_viscosity.png")
...
out = joinpath(FIGS, "impact_viscosity_shear.gif")
...
open(joinpath(@__DIR__, "..", "..", "results", "viscosity_field.csv"), "w") do io
...
println("wrote results/viscosity_field.csv")
