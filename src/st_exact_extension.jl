...
Derivation: `derivations/carreau_yasuda_nonperturbative_derivation.jl`
(single-mode groundwork) and `derivations/carreau_yasuda_multimode_derivation.jl`
...
(`D2`) coefficients via `src/reid.jl`'s exact finite-Oh relations.
"""
...
function characteristic_shear_K(l::Int)
    ...
    # (test/test_carreau_yasuda_exact.jl) suddenly returning K_l^2/l^2
...
# derivations/carreau_yasuda_multimode_derivation.jl, Sections 4 and 4b.
